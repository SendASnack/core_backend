package pt.ua.deti.tqs.sendasnack.core.backend.security.config;
...
import pt.ua.deti.tqs.sendasnack.core.backend.security.auth.AuthEntryPoint;
import pt.ua.deti.tqs.sendasnack.core.backend.security.auth.AuthRequestFilter;
...
public class SecurityRestConfig extends WebSecurityConfigurerAdapter {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:3000", "http://20.77.90.223:3000", "http://20.77.90.223:3001", "http://20.77.90.223:8081"));
